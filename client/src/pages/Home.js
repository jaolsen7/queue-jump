      ...
      <h1>Welcome {isLoggedIn ? user.username : "Guest"}!</h1>
          ...
          <Container>
                  <Card className="col-12 m-3 flex-row flex-wrap">
                    <Card.Img variant="left" src={sampleRestaurant1} className="p-2 col-6" />
                  ...
                  <Card.Img variant="right" src={sampleRestaurant2} className="p-2 col-6" />
                  </Card>
                  <Card className="col-12 m-3 flex-row flex-wrap">
                  <Card.Img variant="left" src={sampleRestaurant3} className="p-2 col-6" />
                    <Card.Body className="col-6">
                      <Card.Title>Taste of Italy</Card.Title>
                      <Card.Text>Cozy atmosphere and delicious food make this restaurant a wonderful location for celebrations and romantic evenings both</Card.Text>
                     <Button className='btn-block btn-success d-block' /*onClick={() => handleDeleteBook(book.bookId)}*/>
                        Check for Reservations
                      </Button>
                    </Card.Body>
